...
const Invite = () => {
    ...
    return (
        <div className='flex flex-col items-start gap-4 w-full h-full justify-start p-4 sd:pl-8'>
            ...
            <h3>
                Most of our services are FREE, Help us to grow faster
            </h3>
            <div className='flex flex-col sd:flex-row gap-2 text-sm'>
                <textarea className='border p-4 rounded-md w-full' cols={40} value="Hey check this career discovery tool, I'm using it: https://careerdekho.ai/ " />
                <button className='border h-10 py-2 px-4 bg-blue-400 max-w-[100px] rounded-md text-white'>copy</button>
            </div>

            <div>OR</div>

            <button className="bg-green-500 px-4 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
